...
public final class SpecialShapeIntegration {
    ...
    /** Dispatch audit helper; pass the exact renderer instance returned during registration. */
    public static boolean isExpectedDispatch(Variant variant, BlockRendererType renderer) {
        return variant != null
